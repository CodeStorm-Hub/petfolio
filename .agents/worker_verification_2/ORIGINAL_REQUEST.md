...
Make sure you do NOT mock or cheat the test results. Let them run completely.
Write the exact terminal outputs of the test runs and static analysis in: j:\GitHub\petfolio\.agents\worker_verification_2\handoff.md
